  ...
  return (
    <>
      ...
      <main className="max-w-3xl mx-auto px-6 py-12 flex-1">
        <h1 className="font-display font-black text-4xl text-[#0f0f0f] mb-2">URL Encoder / Decoder</h1>
        <p className="text-[#9e9e8f] mb-8">Encode or decode URLs and query strings instantly.</p>
        ...
        <textarea
          ...
          rows={6}
          placeholder={mode === "encode" ? "Paste URL or text to encode..." : "Paste encoded URL to decode..."}
